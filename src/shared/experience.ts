...
export const navigationSchema=z.object({viewPins:viewPinsSchema.default({}),collections:collectionsSchema.default(collectionDefaults),collectionOrder:collectionOrderSchema.default([...orderedCollectionKeys]),queueBelowHome:z.boolean().default(false),playlistsBelowHome:z.boolean().default(false),listeningCollapsed:z.boolean().default(false),sidebarCollapsed:z.boolean().default(false)}).strict()
