...
export const appearanceSchema=z.object({colors:z.object({background:color.optional(),panel:color.optional(),accent:color.optional(),text:color.optional(),muted:color.optional()}).strict().default({}),bodyFont:z.enum(fontIds).default('segoe'),headingFont:z.enum(fontIds).default('georgia'),lyricsFont:z.enum(fontIds).default('segoe')}).strict()
export type Appearance=z.infer<typeof appearanceSchema>
export const defaultAppearance:Appearance={colors:{},bodyFont:'segoe',headingFont:'georgia',lyricsFont:'segoe'}
