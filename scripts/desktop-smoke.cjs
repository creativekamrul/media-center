...
async function main() {
  ...
  try {
    ...
    if(process.env.MEDIA_CENTER_UI_CLEANUP_ONLY||process.env.MEDIA_CENTER_CONSISTENCY_ONLY||process.env.MEDIA_CENTER_STUDIO_ONLY||process.env.MEDIA_CENTER_PERSONAL_ONLY||process.env.MEDIA_CENTER_MIXES_ONLY||process.env.MEDIA_CENTER_BUGS_ONLY||process.env.MEDIA_CENTER_POLISH_ONLY){
