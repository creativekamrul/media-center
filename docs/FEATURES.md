...
- **Missing artwork:** branded peach/forest vinyl artwork is bundled for music covers that cannot be loaded. Selected public Cover Art Archive artwork can also be used in Discord. Version 1.1.1 sends the already-published default image URL automatically when music artwork is missing; no per-user asset upload is required.
